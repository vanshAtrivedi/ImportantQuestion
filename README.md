...
```javascript
// Basic Information
valentineName: "Purvi"                    // Your Valentine's name
...
questions: {
    first: {
        ...
        secretAnswer: "I don't like you, I love you bebe! ❤️"  // Hidden message
    },
    second: {
...
celebration: {
    ...
    message: "Now soon you will get your gifts ",          // Celebration message
